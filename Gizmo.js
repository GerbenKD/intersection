...
var ConstructedPoint = Point.extend(function() {
	...
	this.create_sprite = function(svg_object) { 
		this.add_log("created sprite");
		var sprite = svg_object.create_sprite("circle", "points");
...
var ControlPoint = Point.extend(function() {
	...
	this.create_sprite = function(svg_object) {
		var sprite = svg_object.create_sprite("circle", "controlpoints");
...
var Line = Gizmo.extend(function() {
	...
	this.create_sprite = function(svg_object) {
		var sprite = svg_object.create_sprite("line", "lines");
	...
	this.move_sprite = function() {
		...
		var width = sprite.svg_object.width;
		var height = sprite.svg_object.height;
...
var Circle = Gizmo.extend(function() {
	...
	this.create_sprite = function(svg_object) {
		var sprite = svg_object.create_sprite("circle", "lines");
